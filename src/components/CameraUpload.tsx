...
export function CameraUpload({ onPhotoReady, disabled = false }: CameraUploadProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      <div className="flex bg-slate-800/50 p-1 rounded-xl w-full max-w-sm mx-auto">
        <button
      ...
      {mode === "upload" ? (
        ...
        <div className="w-full h-64 rounded-2xl overflow-hidden bg-slate-900 relative border border-slate-700">
          {cameraError ? (
              ...
              {cameraActive && (
                <div className="absolute bottom-4 left-0 right-0 flex justify-center">
                  <button
                    ...
                    className="bg-brand-500 hover:bg-brand-600 text-white rounded-full p-3 shadow-lg transition-transform active:scale-95"
                  >
